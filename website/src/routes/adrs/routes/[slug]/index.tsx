...
import { DefaultMultiColumnLayout } from '@/components/layouts/multi-column-layout-container';
...
export function Slug(props: SlugProps) {
  ...
  return (
    <DefaultMultiColumnLayout>
      ...
      <aside className="hidden pt-10 xl:flex xl:flex-col flex-shrink-0 overflow-y-auto">
