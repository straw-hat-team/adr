...
[RFC 2119](https://www.ietf.org/rfc/rfc2119.txt) and [RFC 8174](https://www.ietf.org/rfc/rfc8174.txt).
...
ADR#XXXXXXXXXX (e.g., [ADR#0000000000](../0000000000/index.mdx)), and must
