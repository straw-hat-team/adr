    ...
    <main className="px-4 max-w-screen-lg xl:max-w-screen-xl mx-auto space-y-10 lg:space-y-20">
      ...
      <section className="grid gap-10 grid-cols-1 lg:grid-cols-2">
        <div className="space-y-4">
          ...
          <p>
            ADRs are a combination of design guidance and a system we use to manage and track that guidance. Learn more
            about how the ADR works in the first ADR!
          </p>
          <Link href={`/adrs/${GENESIS_ADR}`} passHref>
        ...
        <div className="space-y-4">
          ...
          <p>
            Interested in helping with ADRs? Contribute by proposing new guidance, commenting on existing ADRs, or
            fixing typos. All contributions are welcome!
          </p>
          <Link href="/adrs" passHref>
            <a className="inline-flex items-center text-gray-700 dark:text-gray-300 border-2 border-gray-700 hover:border-gray-500 text-white text-lg leading-6 font-semibold py-3 px-6 border border-transparent rounded-xl focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-gray-900 focus:outline-none transition-colors duration-200">
        ...
        <div className="space-y-4">
          ...
          <p>
            ...
            . If you don't find an answer there, file an issue on our GitHub repository.
          </p>
          <a target="_blank" href={DISCUSSIONS_QA_URL} className="inline-flex items-center text-gray-700 dark:text-gray-300 border-2 border-gray-700 hover:border-gray-500 text-white text-lg leading-6 font-semibold py-3 px-6 border border-transparent rounded-xl focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-gray-900 focus:outline-none transition-colors duration-200">
            Ask us on Github
